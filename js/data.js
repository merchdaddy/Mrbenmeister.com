...
const GLC = {
  ...
  lounges: [
    ...
    },
    {
      ...
      video: null,
      review: 'The Mission Cigar & Social is one of the standout lounge experiences in the Nashville area. Outstanding service, a full bar, covered patio, and private rooms make it an easy choice for any occasion.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 9.0, humidor: 8.1, chairs: 8.8, service: 9.5, drinks: 8.5, food: 0, ventilation: 8.8, parking: 10 },
      features: { bar: true, outdoor: true, privateLounge: true, byo: true },
      noiseLevel: 'Relaxed',
      priceLevel: '$$$',
      bestFor: ['Date Night', 'Private Events', 'Business Meeting', 'Friends'],
      isFeatured: false,
    ...
    },
    {
      ...
      video: null,
      review: 'Helios Cigar Lounge is a solid, no-frills lounge in Riverside with a good humidor and attentive service. A reliable neighborhood option without a bar or outdoor seating.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 7.9, humidor: 8.1, chairs: 8.1, service: 8.8, drinks: 7.0, food: 0, ventilation: 8.1, parking: 7.5 },
      features: { bar: false, outdoor: false, privateLounge: false, byo: false },
      noiseLevel: 'Relaxed',
      priceLevel: '$$$',
      bestFor: ['Solo Smoke', 'Quick Visit'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      ...
      video: null,
      review: 'Casa de Montecristo in Nashville leads with an exceptional humidor — one of the best selections you\'ll find in Tennessee. The bar and BYOC policy make it flexible, though service has room to grow.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 8.1, humidor: 9.3, chairs: 8.0, service: 7.2, drinks: 8.0, food: 0, ventilation: 8.1, parking: 8.1 },
      features: { bar: true, outdoor: false, privateLounge: false, byo: true },
      noiseLevel: 'Moderate',
      priceLevel: '$$$',
      bestFor: ['Humidor Shopping', 'Date Night', 'Solo Smoke'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      ...
      video: null,
      review: 'Classic Cigars & Lounge is a downtown Tulsa gem with an impressive humidor, comfortable seating, a full bar, and a patio. One of the better all-around lounge experiences in Oklahoma.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 8.4, humidor: 9.3, chairs: 8.7, service: 8.4, drinks: 8.5, food: 0, ventilation: 8.5, parking: 7.2 },
      features: { bar: true, outdoor: true, privateLounge: false, byo: true },
      noiseLevel: 'Moderate',
      priceLevel: '$$$',
      bestFor: ['Friends', 'Date Night', 'Business Meeting', 'Humidor Shopping'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      ...
      video: null,
      review: "Shelly's Back Room is one of the most conveniently located cigar lounges in Washington, D.C. While the humidor selection is fairly limited, the lounge allows you to bring your own cigars, making it a great stop if you're already in the city. The full bar and classic atmosphere make it an excellent place to unwind after a day of sightseeing or business.",
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 7.8, humidor: 5.0, chairs: 8.4, service: 7.8, drinks: 8.5, food: 8.8, ventilation: 8.8, parking: 7.0 },
      features: { bar: true, outdoor: false, privateLounge: false, byo: true },
      noiseLevel: 'Moderate',
      priceLevel: '$$$',
      bestFor: ['After Work', 'Solo Smoke', 'Visitors to DC'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      ...
      video: null,
      review: 'Casa de Montecristo consistently offers one of the best humidors and cigar selections you\'ll find anywhere. The Dallas location is a great place to visit during the day, while evenings tend to be much livelier and more social. If you\'re looking for a quiet place to work, this may not be the ideal spot after hours, but the outstanding selection easily makes it worth the visit.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 8.6, humidor: 9.3, chairs: 8.5, service: 8.3, drinks: 8.3, food: 0, ventilation: 8.3, parking: 9.0 },
      features: { bar: true, outdoor: false, privateLounge: false, byo: true },
      noiseLevel: 'Lively evenings',
      priceLevel: '$$$',
      bestFor: ['Humidor Shopping', 'Date Night', 'Friends'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      ...
      video: null,
      review: 'Fair Oaks Cigar Lounge offers one of the better humidor selections in Southern California. Like many California lounges, it\'s a bit smaller and less comfortable than lounges in other parts of the country, and the state\'s cigar taxes noticeably increase prices. Its excellent parking and prime Newport Beach location make it a convenient stop, with plenty to do nearby before or after your smoke.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 8.1, humidor: 8.8, chairs: 7.9, service: 7.9, drinks: 6.5, food: 0, ventilation: 8.7, parking: 8.5 },
      features: { bar: false, outdoor: false, privateLounge: false, byo: false },
      noiseLevel: 'Relaxed',
      priceLevel: '$$$',
      bestFor: ['Solo Smoke', 'Quick Visit', 'Humidor Shopping'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      ...
      city: 'The Colony', country: 'USA', state: 'TX',
      address: '5000 State Hwy 121, The Colony, TX 75056',
      phone: '(972) 370-8700',
      website: 'https://www.cigarsinternational.com/retail/store/texas-the-colony-super-store/2028254/',
      googleBusiness: 'https://maps.google.com/?q=Cigars+International+Superstore+The+Colony+TX',
      lat: 33.0843, lng: -96.8856,
      ...
      video: null,
      review: 'The Cigars International Superstore in The Colony features one of the most impressive humidors in the country. During the day it\'s an outstanding place to relax and enjoy a cigar, while weekend evenings transform the lounge into a lively, high-energy destination that can feel more like a nightclub than a traditional cigar lounge. Whether that\'s a positive depends entirely on the atmosphere you\'re looking for, but the cigar selection alone makes it a must-visit.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 8.9, humidor: 9.8, chairs: 8.5, service: 8.3, drinks: 8.6, food: 0, ventilation: 9.1, parking: 9.1 },
      features: { bar: true, outdoor: true, privateLounge: false, byo: true },
      noiseLevel: 'Lively evenings',
      priceLevel: '$$',
      bestFor: ['Humidor Shopping', 'Friends', 'Special Occasion'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
    ...
    {
      id: 'l20',
      name: 'Stogies on Grand',
      city: 'St. Paul', country: 'USA', state: 'MN',
      address: '1696 Grand Ave, St. Paul, MN 55105',
      phone: '(651) 222-5093',
      website: '',
      googleBusiness: 'https://maps.google.com/?q=Stogies+on+Grand+St+Paul+MN',
      lat: 44.9394, lng: -93.1504,
      img: '/images/Stogies On Grand St Paul Minneapolis/stogies on grand front.HEIC',
      photos: [
        '/images/Stogies On Grand St Paul Minneapolis/stogies on grand front.HEIC',
        '/images/Stogies On Grand St Paul Minneapolis/stogies on grand front 2.HEIC',
        '/images/Stogies On Grand St Paul Minneapolis/Stogies on grand 1.HEIC',
        '/images/Stogies On Grand St Paul Minneapolis/Humidor 1.HEIC',
        '/images/Stogies On Grand St Paul Minneapolis/Humidor 2.HEIC',
      ],
      video: '/images/Stogies On Grand St Paul Minneapolis/IMG_5271.MOV',
      review: 'Stogies on Grand has the feel of a true local cigar club where regulars gather and spend time. The space is definitely rough around the edges and cleanliness could use improvement. It can also feel a little less welcoming to outsiders at first, as it has a strong group of established regulars. If you can get past that, it offers an authentic, no-frills neighborhood cigar experience.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 7.4, humidor: 8.2, chairs: 7.5, service: 7.2, drinks: 0, food: 0, ventilation: 7.3, parking: 7.0 },
      features: { bar: false, outdoor: true, privateLounge: false, byo: false },
      noiseLevel: 'Moderate — Regular crowd',
      priceLevel: '$$',
      bestFor: ['Solo Smoke', 'Local Experience'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
    {
      id: 'l21',
      name: 'Cigar Source',
      city: 'Des Moines', country: 'USA', state: 'IA',
      address: 'Des Moines, IA',
      phone: '',
      website: '',
      googleBusiness: 'https://maps.google.com/?q=Cigar+Source+Des+Moines+Iowa',
      lat: 41.5868, lng: -93.6250,
      img: '/images/Cigar source Des moines Iowa/FRONT.HEIC',
      photos: [
        '/images/Cigar source Des moines Iowa/FRONT.HEIC',
        '/images/Cigar source Des moines Iowa/front 2.HEIC',
        '/images/Cigar source Des moines Iowa/cigar source iowa 1.HEIC',
        '/images/Cigar source Des moines Iowa/cigar source iowa 2.HEIC',
        '/images/Cigar source Des moines Iowa/cigar source iowa 3.HEIC',
      ],
      video: '/images/Cigar source Des moines Iowa/IMG_5237.MOV',
      review: 'Cigar Source is an amazing place to find rare and hard-to-source cigars. They have a huge humidor with an excellent selection, along with a wide variety of cigar accessories including personal humidors, travel humidors, cutters, lighters, and more. This is primarily a destination for purchasing cigars and accessories rather than a traditional cigar lounge, so it is not a place to properly sit down and smoke.',
      reviewHtml: null,
      reviewPending: false,
      ratings: { overall: 8.7, humidor: 9.3, chairs: 0, service: 7.8, drinks: 0, food: 0, ventilation: 0, parking: 9.0 },
      features: { bar: false, outdoor: false, privateLounge: false, byo: false },
      noiseLevel: 'Quiet — Retail focused',
      priceLevel: '$$',
      bestFor: ['Humidor Shopping', 'Accessories', 'Rare Finds'],
      isFeatured: false,
      visitedDate: 'July 2026'
    },
  ],
